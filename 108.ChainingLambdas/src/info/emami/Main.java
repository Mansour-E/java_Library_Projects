...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Function<String, String> lastName = s -> s.concat(" Emami");
        Function<String, String> uCaseLastName = uCase.andThen(lastName);
        System.out.println(uCaseLastName.apply(name));

        Function<String, String[]> f0 = uCase.andThen(s -> s.concat(" Emami")).andThen(s -> s.split(" "));
        System.out.println(Arrays.toString(f0.apply(name)));

        Function<String, String> f1 = uCase.
                andThen(s -> s.concat(" Emami")).
                andThen(s -> s.split(" ")).
        ...
        Predicate<String> p1 = s -> s.equals("MANSOUR");
        Predicate<String> p2 = s -> s.equalsIgnoreCase("Mansour");
